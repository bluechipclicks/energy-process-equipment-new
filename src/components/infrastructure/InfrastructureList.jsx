// components/InfrastructureList.js
...
const infrastructureData = [
  {
    ...
    machineData2: [
      "CNC Computerized fully auto-matic with Plasma system"
    ]
  },
  {
    ...
    machineData2: [
      "Electronics Operated Fully Automatic"
    ]
  },
  {
    makerName: "Standard",
    ...
    size: "400 Amp. (Each)",
    machineData2: [
      "Electrically operated welding rectifier"
    ]
  },
  {
  ...
  },
  {
    ...
    machineData2: [
      "Heavy Duty Radial Drilling M/c with boring attachment"
    ]
  },
  {
    makerName: "Saraswati",
  ...
  },
  {
    ...
    machineData2: [
      ...
      "Portable Disc Grinder, AG-7, AG-9 & CQ-4 Type",
    ]
  },
  {
    makerName: "Super",
  ...
  },
  {
    ...
    machineData2: [
      "M/c. with 1 H.P. motor Pulley & V-Belts"
    ]
  },
  {
    makerName: "Sagar",
  ...
  },
  {
    ...
    size: "32 mm Thick.",
    machineData2: [
      "Pug cutting M/c. with Circle cutting track"
    ]
  },
  {
    makerName: "Wolf",
  ...
  },
  {
    ...
    size: "Up to 14 Ton",
    machineData2: [
      "For Material Handling (Erection Crane)"
    ]
  },
  {
    makerName: "EPE",
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {infrastructureData.map((data, index) => (
            <div key={index} className="bg-white p-8 rounded-lg text-center shadow-md border-b-4 border-b-[#DC2621] border-t border-t-gray-200/40 hover:scale-105 hover:shadow-lg">
